...
// You are given a 0-indexed integer array tickets of 
// length n where the number of tickets that the ith person 
...
// of the line (which happens instantaneously) in order to buy more tickets. 
// If a person does not have any tickets left to buy, the person will leave the line.

// Return the time taken for the person initially at 
